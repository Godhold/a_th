...
<section class="section">
  ...
  <div class="container">
    <div class="row">
      <div
        ...
        <h1 class="h2 mb-4"><mark>Feeds</mark></h1>
        <?php
        $get_post = mysqli_query($connect,"SELECT * FROM post  ORDER BY date_created DESC");
        if(!$get_post){
            echo "Error Occured";
        }else{
  ...
  <div class="widget widget-categories">
    ...
    <ul class="list-unstyled widget-list">
      ...
      <li><a href="category?cat=Europe" class="d-flex">Europe </small></a></li>
      <li><a href="category?cat=Uk" class="d-flex">Uk </a></li>
      <li><a href="category?cat=Africa" class="d-flex">Africa </small></a></li>
      <li><a href="category?cat=Asia" class="d-flex">Asia </small></a></li>
