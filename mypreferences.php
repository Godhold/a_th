        ...
        <div class="card-header text-center">
          ...
          <div class="form-group">
            ...
            <select name="category" class="form-control" id="category" required>
                ...
                <option value="student"> America</option>
                <option value="faculty">Uk</option>
                <option value="staff">Europe</option>
                <option value="Honeymoon travel">Asia</option>
                <option value="Pilgrimage travel">Africa</option>
                <option value="Religious tourism">Australia</option>
            </select>
          </div>
          <div class="form-group">
